...
async def main():
    ...
    if switch == "DPS":
        ...
        id_scope = '0ne006847A2'
        registration_id = '1knoriwirln'
        symmetric_key = "+Gvj8Cw0DyLRrEbmwPy9crpOIY2CMo/q/yiKLz5kgxg="
        ...
        conn_str = 'HostName=iothub-we-water-dev-2.azure-devices.net;DeviceId=sample-pump-1;SharedAccessKey=Bbjtndt/d4vaYUDAlhpasJiLwI1M/1wiPYz83VpFF+U='
